...
public class RNWebViewManager extends SimpleViewManager<WebView> {
  ...
  protected static class ReactWebView extends WebView implements LifecycleEventListener {
    ...
    /**
     * WebView must be created with an context createViewInstanceof the current activity
     *
  ...
  protected WebView createViewInstance(ThemedReactContext reactContext) {
    ...
    webView.setWebChromeClient(new WebChromeClient() {
      ...
      public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
        return getPackage().getModule().startFileChooserIntent(filePathCallback, fileChooserParams.createIntent());
      }
