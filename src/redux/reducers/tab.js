...
const menu_leader = require('../../../source/img/tabs/menu_leader.png');
const menu_leader_click = require('../../../source/img/tabs/menu_leader_click.png');
...
const unLoginTabs = [
    ...
    {key: 'ZG', selectImage: menu_leader, unSelectImage: menu_leader_click, title: '业务'},
